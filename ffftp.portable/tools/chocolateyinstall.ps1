...
$url        = 'https://github.com/ffftp/ffftp/releases/download/v3.6/ffftp-v3.6-x86.zip'
$url64      = 'https://github.com/ffftp/ffftp/releases/download/v3.6/ffftp-v3.6-x64.zip'
$ErrorActionPreference = 'Stop';
