...
$url        = 'https://github.com/ffftp/ffftp/releases/download/v3.8/ffftp-v3.8-x86.zip'
$url64      = 'https://github.com/ffftp/ffftp/releases/download/v3.8/ffftp-v3.8-x64.zip'
$ErrorActionPreference = 'Stop';
